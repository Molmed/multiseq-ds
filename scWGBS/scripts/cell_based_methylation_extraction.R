...
parser$add_argument("--path_cell_data_1", type="character", help="Directory of the cell coverage and methylation data")
parser$add_argument("--path_cell_data_2", type="character", help="Directory of the cell coverage and methylation data")
parser$add_argument("--path_cell_data_3", type="character", help="Directory of the cell coverage and methylation data")
...
cov_file <- Sys.glob(file.path(args$path_cell_data_1, paste0("*", args$cell_ID, "*", "strandmerged.cov.gz")))

if(length(cov_file) == 0){
  cov_file <- Sys.glob(file.path(args$path_cell_data_2,paste0("*", args$cell_ID, "*", "strandmerged.cov.gz")))
}

if(length(cov_file) == 0){
  cov_file <- Sys.glob(file.path(args$path_cell_data_3,paste0("*", args$cell_ID, "*", "strandmerged.cov.gz")))
}
